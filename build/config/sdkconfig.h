...
#define CONFIG_BT_NIMBLE_HIGH_DUTY_ADV_ITVL 1
#define CONFIG_BT_NIMBLE_HOST_QUEUE_CONG_CHECK 1
...
#define CONFIG_BLE_MESH_ACTIVE_SCAN 1
...
#define CONFIG_ESP_MAIN_TASK_AFFINITY_NO_AFFINITY 1
#define CONFIG_ESP_MAIN_TASK_AFFINITY 0x7FFFFFFF
